...
Synthetic evaluation can generate larger batches of realistic intake messages
without Telegram and compare Hermes mock against a shadow LLM endpoint. See
[backend/docs/SYNTHETIC_EVALUATION.md](./backend/docs/SYNTHETIC_EVALUATION.md)
and run `make synthetic-cases` then `make synthetic-shadow-eval`.
