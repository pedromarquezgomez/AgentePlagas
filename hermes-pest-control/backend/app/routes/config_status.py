...
async def config_status() -> dict[str, bool | str]:
    return {
        ...
        "hermes_shadow_mode": settings.hermes_shadow_mode,
        "hermes_shadow_api_url_configured": bool(settings.hermes_shadow_api_url),
        "hermes_shadow_api_key_configured": bool(settings.hermes_shadow_api_key),
        "hermes_shadow_sample_rate": str(settings.hermes_shadow_sample_rate),
        "hermes_pilot_mode": settings.hermes_pilot_mode,
        "hermes_pilot_allowed_channels": settings.hermes_pilot_allowed_channels,
        "hermes_pilot_sample_rate": str(settings.hermes_pilot_sample_rate),
        "hermes_pilot_require_gate": settings.hermes_pilot_require_gate,
        "hermes_agent_mode": settings.hermes_agent_mode,
        "hermes_agent_api_key_configured": bool(settings.hermes_agent_api_key),
        "hermes_skills_dir_configured": bool(settings.hermes_skills_dir),
        "llm_provider": settings.llm_provider,
        "llm_active_mode": settings.llm_active_mode,
